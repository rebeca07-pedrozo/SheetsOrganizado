function revisarRegistrosDatos() {
  ...
  if (!huboRegistros) {
    var asuntoJefes = "Alerta: No hubo registros en Datos SALUD A SU INTEGRAL  el " + fechaAyerStr;
    ...
    var asuntoExito = "Reporte: Sí hubo registros en Datos SALUD A SU INTEGRAL el el " + fechaAyerStr;
