function revisarRegistrosDatos() {
  ...
  if (!huboRegistros) {
    var asuntoJefes = "Alerta: No hubo registros en datos CREDITOS  el " + fechaAyerStr;
    ...
    var asuntoExito = "Reporte: Sí hubo registros en en datos CREDITOS el " + fechaAyerStr;
