function revisarRegistrosDatos() {
  ...
  if (!huboRegistros) {
    var asuntoJefes = "Alerta: No hubo registros en Datos SALUD A SU MEDIDA el " + fechaAyerStr;
    ...
    var asuntoExito = "Reporte: Sí hubo registros en Datos SALUD A SU MEDIDA el el " + fechaAyerStr;
